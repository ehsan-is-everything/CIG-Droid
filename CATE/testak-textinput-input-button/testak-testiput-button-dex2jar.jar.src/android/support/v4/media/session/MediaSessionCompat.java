...
public class MediaSessionCompat
{
    ...
    implements Parcelable
  {
    ...
    public static List<QueueItem> fromQueueItemList(List<?> paramList)
    {
      ...
      for (;;)
      {
        return (List<QueueItem>)localObject;
...
/* Location:              C:\Users\Lab\Desktop\testak-testiput-button-dex2jar.jar!\android\support\v4\media\session\MediaSessionCompat.class
