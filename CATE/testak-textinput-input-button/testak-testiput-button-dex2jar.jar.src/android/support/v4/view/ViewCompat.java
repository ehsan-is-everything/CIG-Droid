    ...
    extends ViewCompat.KitKatViewCompatImpl
  {
    ...
    public void setOnApplyWindowInsetsListener(View paramView, final OnApplyWindowInsetsListener paramOnApplyWindowInsetsListener)
    {
      ...
      ViewCompatLollipop.setOnApplyWindowInsetsListener(paramView, new ViewCompatLollipop.OnApplyWindowInsetsListenerBridge()
      {
        ...
        {
          WindowInsetsCompat localWindowInsetsCompat = WindowInsetsCompat.wrap(paramAnonymousObject);
          return WindowInsetsCompat.unwrap(paramOnApplyWindowInsetsListener.onApplyWindowInsets(paramAnonymousView, localWindowInsetsCompat));
        }
      });
    }
...
/* Location:              C:\Users\Lab\Desktop\testak-testiput-button-dex2jar.jar!\android\support\v4\view\ViewCompat.class
