    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (i5 != 0)
        {
          ...
          if (i7 < 0)
          {
            this.mEdgeGlowTop.onPull(i1 / getHeight(), paramMotionEvent.getX(m) / getWidth());
            if (!this.mEdgeGlowBottom.isFinished()) {
              this.mEdgeGlowBottom.onRelease();
            }
          }
          while ((this.mEdgeGlowTop != null) && ((!this.mEdgeGlowTop.isFinished()) || (!this.mEdgeGlowBottom.isFinished())))
          {
            ...
            if (i7 > i3)
            {
              this.mEdgeGlowBottom.onPull(i1 / getHeight(), 1.0F - paramMotionEvent.getX(m) / getWidth());
              if (!this.mEdgeGlowTop.isFinished()) {
                this.mEdgeGlowTop.onRelease();
              }
            }
...
/* Location:              C:\Users\Lab\Desktop\testak-testiput-button-dex2jar.jar!\android\support\v4\widget\NestedScrollView.class
