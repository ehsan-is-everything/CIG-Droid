    ...
    if (localArrayList1 != null) {
      for (int i = 0; i < this.mActive.size(); i++)
      {
        ...
        if (localFragment != null)
        {
          ...
          label205:
          for (int m = localFragment.mTarget.mIndex;; m = -1)
          {
            localFragment.mTargetIndex = m;
            if (DEBUG) {
              Log.v("FragmentManager", "retainNonConfig: keeping retained " + localFragment);
            }
            FragmentManagerImpl localFragmentManagerImpl = localFragment.mChildFragmentManager;
            j = 0;
            if (localFragmentManagerImpl == null) {
              break label221;
            }
            localFragmentManagerNonConfig = localFragment.mChildFragmentManager.retainNonConfig();
            j = 0;
...
/* Location:              C:\Users\Lab\Desktop\testak-testiput-button-dex2jar.jar!\android\support\v4\app\FragmentManagerImpl.class
