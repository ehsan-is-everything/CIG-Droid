  ...
  static NotificationCompatBase.UnreadConversation getUnreadConversationFromBundle(Bundle paramBundle, NotificationCompatBase.UnreadConversation.Factory paramFactory, RemoteInputCompatBase.RemoteInput.Factory paramFactory1)
  {
    ...
    for (int j = 0;; j++)
    {
      ...
      for (i = 0;; i = 0)
      {
        ...
        return paramFactory.build((String[])localObject, localRemoteInput1, localPendingIntent2, localPendingIntent1, arrayOfString1, paramBundle.getLong("timestamp"));
...
/* Location:              C:\Users\Lab\Desktop\testak-testiput-button-dex2jar.jar!\android\support\v4\app\NotificationCompatApi21.class
