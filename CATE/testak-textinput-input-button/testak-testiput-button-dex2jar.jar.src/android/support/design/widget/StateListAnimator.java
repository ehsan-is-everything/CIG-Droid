...
final class StateListAnimator
{
  ...
  void setState(int[] paramArrayOfInt)
  {
    ...
    do
    {
      ...
      this.mLastMatch = ((Tuple)localObject);
    } while (localObject == null);
    start((Tuple)localObject);
  }
...
/* Location:              C:\Users\Lab\Desktop\testak-testiput-button-dex2jar.jar!\android\support\design\widget\StateListAnimator.class
