  ...
  implements NestedScrollingParent
{
  ...
  private void offsetChildByInset(View paramView, Rect paramRect, int paramInt)
  {
    ...
    {
      if (!localRect.intersect(paramView.getLeft(), paramView.getTop(), paramView.getRight(), paramView.getBottom())) {
    ...
    do
    {
      ...
      if (j == 48)
      {
        int i5 = localRect.top - localLayoutParams.topMargin - localLayoutParams.mInsetOffsetY;
      ...
      if ((i & 0x50) == 80)
      {
        int i4 = getHeight() - localRect.bottom - localLayoutParams.bottomMargin + localLayoutParams.mInsetOffsetY;
      ...
      if (m == 3)
      {
        int i2 = localRect.left - localLayoutParams.leftMargin - localLayoutParams.mInsetOffsetX;
      ...
      if ((i & 0x5) == 5)
      {
        int i1 = getWidth() - localRect.right - localLayoutParams.rightMargin + localLayoutParams.mInsetOffsetX;
  ...
  final void onChildViewsChanged(int paramInt)
  {
    ...
    Rect localRect1 = this.mTempRect4;
    localRect1.setEmpty();
    int k = 0;
    if (k < j)
    {
      ...
      Rect localRect2 = this.mTempRect1;
      getChildRect(localView1, true, localRect2);
      int i1;
      if ((localLayoutParams1.insetEdge != 0) && (!localRect2.isEmpty())) {
        i1 = GravityCompat.getAbsoluteGravity(localLayoutParams1.insetEdge, i);
      }
      switch (i1 & 0x70)
      {
      default: 
...
/* Location:              C:\Users\Lab\Desktop\testak-testiput-button-dex2jar.jar!\android\support\design\widget\CoordinatorLayout.class
