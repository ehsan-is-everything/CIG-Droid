  ...
  extends FloatingActionButtonIcs
{
  ...
  void onElevationsChanged(float paramFloat1, float paramFloat2)
  {
    ...
    localAnimatorSet4.play(ObjectAnimator.ofFloat(this.mView, View.TRANSLATION_Z, new float[] { 0.0F }).setDuration(100L)).after(100L);
    localAnimatorSet3.play(ObjectAnimator.ofFloat(this.mView, "elevation", new float[] { paramFloat1 }).setDuration(0L)).with(localAnimatorSet4);
    localAnimatorSet3.setInterpolator(ANIM_INTERPOLATOR);
    localStateListAnimator.addState(ENABLED_STATE_SET, localAnimatorSet3);
    AnimatorSet localAnimatorSet5 = new AnimatorSet();
    localAnimatorSet5.play(ObjectAnimator.ofFloat(this.mView, "elevation", new float[] { 0.0F }).setDuration(0L)).with(ObjectAnimator.ofFloat(this.mView, View.TRANSLATION_Z, new float[] { 0.0F }).setDuration(0L));
    localAnimatorSet5.setInterpolator(ANIM_INTERPOLATOR);
    localStateListAnimator.addState(EMPTY_STATE_SET, localAnimatorSet5);
...
/* Location:              C:\Users\Lab\Desktop\testak-testiput-button-dex2jar.jar!\android\support\design\widget\FloatingActionButtonLollipop.class
