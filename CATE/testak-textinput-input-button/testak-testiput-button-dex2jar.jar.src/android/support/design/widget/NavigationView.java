  ...
  extends ScrimInsetsFrameLayout
{
  ...
  public NavigationView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    setBackgroundDrawable(localTintTypedArray.getDrawable(R.styleable.NavigationView_android_background));
...
/* Location:              C:\Users\Lab\Desktop\testak-testiput-button-dex2jar.jar!\android\support\design\widget\NavigationView.class
