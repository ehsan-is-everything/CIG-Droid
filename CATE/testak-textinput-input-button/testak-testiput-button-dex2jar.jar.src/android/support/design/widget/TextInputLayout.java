  ...
  extends LinearLayout
{
  ...
  public TextInputLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      boolean bool2 = localTintTypedArray.getBoolean(R.styleable.TextInputLayout_errorEnabled, false);
      ...
      this.mPasswordToggleEnabled = localTintTypedArray.getBoolean(R.styleable.TextInputLayout_passwordToggleEnabled, true);
  ...
  public void addView(View paramView, int paramInt, ViewGroup.LayoutParams paramLayoutParams)
  {
    ...
    {
      this.mInputFrame.addView(paramView, new FrameLayout.LayoutParams(paramLayoutParams));
...
/* Location:              C:\Users\Lab\Desktop\testak-testiput-button-dex2jar.jar!\android\support\design\widget\TextInputLayout.class
