  ...
  extends ValueAnimatorCompat.Impl
{
  ...
  final void update()
  {
    if (this.mIsRunning)
    {
      float f = MathUtils.constrain((float)(SystemClock.uptimeMillis() - this.mStartTime) / (float)this.mDuration, 0.0F, 1.0F);
      if (this.mInterpolator != null) {
...
/* Location:              C:\Users\Lab\Desktop\testak-testiput-button-dex2jar.jar!\android\support\design\widget\ValueAnimatorCompatImplGingerbread.class
