    ...
    extends HeaderBehavior<AppBarLayout>
  {
    ...
    private void updateAppBarLayoutDrawableState(CoordinatorLayout paramCoordinatorLayout, AppBarLayout paramAppBarLayout, int paramInt1, int paramInt2)
    {
      ...
      do
      {
        for (;;)
        {
          if ((paramAppBarLayout.setCollapsedState(bool)) && (Build.VERSION.SDK_INT >= 11) && (shouldJumpElevationState(paramCoordinatorLayout, paramAppBarLayout))) {
    ...
    public boolean onLayoutChild(CoordinatorLayout paramCoordinatorLayout, AppBarLayout paramAppBarLayout, int paramInt)
    {
      ...
      if (i != 0) {
        if ((i & 0x4) != 0)
        {
          ...
          animateOffsetTo(paramCoordinatorLayout, paramAppBarLayout, n, 0.0F);
        }
      }
      label102:
      label114:
    ...
    int setHeaderTopBottomOffset(CoordinatorLayout paramCoordinatorLayout, AppBarLayout paramAppBarLayout, int paramInt1, int paramInt2, int paramInt3)
    {
      ...
      if ((paramInt2 != 0) && (i >= paramInt2) && (i <= paramInt3))
      {
        ...
        for (int n = -1;; n = 1)
        {
          updateAppBarLayoutDrawableState(paramCoordinatorLayout, paramAppBarLayout, j, n);
          return k;
          m = j;
          break;
        }
...
/* Location:              C:\Users\Lab\Desktop\testak-testiput-button-dex2jar.jar!\android\support\design\widget\AppBarLayout.class
