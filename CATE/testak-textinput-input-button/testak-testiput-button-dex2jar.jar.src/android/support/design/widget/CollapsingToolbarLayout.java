  ...
  extends FrameLayout
{
  ...
  {
    return (this.mToolbarDrawIndex >= 0) && (this.mToolbarDrawIndex == 1 + indexOfChild(paramView));
  }
  ...
  protected boolean drawChild(Canvas paramCanvas, View paramView, long paramLong)
  {
    ...
    if ((this.mContentScrim != null) && (this.mScrimAlpha > 0) && (isToolbarChildDrawnNext(paramView)))
    {
      this.mContentScrim.mutate().setAlpha(this.mScrimAlpha);
      this.mContentScrim.draw(paramCanvas);
      bool = true;
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((this.mCollapsingTitleEnabled) && (this.mDummyView != null))
    {
      ...
      if (this.mDrawCollapsingTitle)
      {
        ...
        int i7 = this.mExpandedMarginTop;
        int i8 = paramInt3 - paramInt1;
        if (k == 0) {
          break label503;
        }
        i9 = this.mExpandedMarginStart;
        label335:
...
/* Location:              C:\Users\Lab\Desktop\testak-testiput-button-dex2jar.jar!\android\support\design\widget\CollapsingToolbarLayout.class
