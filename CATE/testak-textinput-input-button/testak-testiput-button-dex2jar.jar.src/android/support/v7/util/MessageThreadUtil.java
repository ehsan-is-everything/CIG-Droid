  ...
  implements ThreadUtil<T>
{
  ...
  static class MessageQueue
  {
    ...
    MessageThreadUtil.SyncQueueItem next()
    {
      ...
      //   1: monitorenter
      //   2: aload_0
      //   3: getfield 14	android/support/v7/util/MessageThreadUtil$MessageQueue:mRoot	Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   6: astore_2
      //   7: aload_2
      //   8: ifnonnull +9 -> 17
      //   11: aconst_null
      ...
      //   16: areturn
      //   17: aload_0
      //   18: getfield 14	android/support/v7/util/MessageThreadUtil$MessageQueue:mRoot	Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   21: astore_3
      //   22: aload_0
      //   23: aload_0
      //   24: getfield 14	android/support/v7/util/MessageThreadUtil$MessageQueue:mRoot	Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   27: invokestatic 20	android/support/v7/util/MessageThreadUtil$SyncQueueItem:access$000	(Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;)Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   30: putfield 14	android/support/v7/util/MessageThreadUtil$MessageQueue:mRoot	Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   33: goto -20 -> 13
      //   36: astore_1
      //   37: aload_0
      //   38: monitorexit
      ...
      //   6	2	2	localSyncQueueItem1	MessageThreadUtil.SyncQueueItem
      //   12	10	3	localSyncQueueItem2	MessageThreadUtil.SyncQueueItem
      // Exception table:
      //   from	to	target	type
      //   2	7	36	finally
      //   17	33	36	finally
    ...
    void sendMessage(MessageThreadUtil.SyncQueueItem paramSyncQueueItem)
    {
      ...
      //   9: aload_0
      //   10: aload_1
      //   11: putfield 14	android/support/v7/util/MessageThreadUtil$MessageQueue:mRoot	Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   14: aload_0
      //   15: monitorexit
      //   16: return
      //   17: aload_0
      ...
      //   21: astore_3
      //   22: aload_3
      //   23: invokestatic 20	android/support/v7/util/MessageThreadUtil$SyncQueueItem:access$000	(Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;)Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   26: ifnull +11 -> 37
      //   29: aload_3
      //   30: invokestatic 20	android/support/v7/util/MessageThreadUtil$SyncQueueItem:access$000	(Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;)Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   33: astore_3
      //   34: goto -12 -> 22
      //   37: aload_3
      //   38: aload_1
      //   39: invokestatic 33	android/support/v7/util/MessageThreadUtil$SyncQueueItem:access$002	(Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;)Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   42: pop
      //   43: goto -29 -> 14
      //   46: astore_2
      //   47: aload_0
      ...
      //   21	17	3	localSyncQueueItem	MessageThreadUtil.SyncQueueItem
      // Exception table:
      //   from	to	target	type
      //   2	14	46	finally
      //   17	22	46	finally
...
/* Location:              C:\Users\Lab\Desktop\testak-testiput-button-dex2jar.jar!\android\support\v7\util\MessageThreadUtil.class
