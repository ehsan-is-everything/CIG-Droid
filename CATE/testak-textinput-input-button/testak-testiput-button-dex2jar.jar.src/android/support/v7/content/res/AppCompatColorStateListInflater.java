...
final class AppCompatColorStateListInflater
{
    ...
    throws XmlPullParserException, IOException
  {
    ...
    for (;;)
    {
      ...
      break label224;
      label275:
      int[] arrayOfInt6 = StateSet.trimStateSet(arrayOfInt5, i3);
      int i4 = modulateColorAlpha(n, f);
      if ((j != 0) && (arrayOfInt6.length == 0)) {}
      arrayOfInt2 = GrowingArrayUtils.append(arrayOfInt2, j, i4);
      arrayOfInt1 = (int[][])GrowingArrayUtils.append(arrayOfInt1, j, arrayOfInt6);
      j++;
      break;
      int[] arrayOfInt3 = new int[j];
      int[][] arrayOfInt4 = new int[j][];
      System.arraycopy(arrayOfInt2, 0, arrayOfInt3, 0, j);
      System.arraycopy(arrayOfInt1, 0, arrayOfInt4, 0, j);
      ColorStateList localColorStateList = new ColorStateList(arrayOfInt4, arrayOfInt3);
...
/* Location:              C:\Users\Lab\Desktop\testak-testiput-button-dex2jar.jar!\android\support\v7\content\res\AppCompatColorStateListInflater.class
