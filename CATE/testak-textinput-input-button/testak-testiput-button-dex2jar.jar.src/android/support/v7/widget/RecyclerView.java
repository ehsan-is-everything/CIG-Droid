  ...
  implements ScrollingView, NestedScrollingChild
{
  ...
  private RecyclerView.ItemAnimator.ItemAnimatorListener mItemAnimatorListener = new ItemAnimatorRestoreListener();
  ...
  private void initChildrenHelper()
  {
    this.mChildHelper = new ChildHelper(new ChildHelper.Callback()
    {
      ...
      public void onEnteredHiddenState(View paramAnonymousView)
      {
        RecyclerView.ViewHolder localViewHolder = RecyclerView.getChildViewHolderInt(paramAnonymousView);
        if (localViewHolder != null) {
          RecyclerView.ViewHolder.access$200(localViewHolder);
        }
      }
      ...
      public void onLeftHiddenState(View paramAnonymousView)
      {
        RecyclerView.ViewHolder localViewHolder = RecyclerView.getChildViewHolderInt(paramAnonymousView);
        if (localViewHolder != null) {
          RecyclerView.ViewHolder.access$300(localViewHolder);
        }
      }
  ...
  private void recoverFocusFromState()
  {
    ...
    do
    {
      ...
      } while ((localView2 == null) || (!this.mChildHelper.isHidden(localView2)));
      int i = this.mState.mFocusedItemPosition;
      localViewHolder = null;
      if (i != -1) {
        localViewHolder = findViewHolderForAdapterPosition(this.mState.mFocusedItemPosition);
      }
      if ((localViewHolder == null) && (this.mState.mFocusedItemId != -1L) && (this.mAdapter.hasStableIds())) {
        localViewHolder = findViewHolderForItemId(this.mState.mFocusedItemId);
      }
    } while ((localViewHolder == null) || (localViewHolder.itemView.hasFocus()) || (!localViewHolder.itemView.hasFocusable()));
    Object localObject = localViewHolder.itemView;
    if (this.mState.mFocusedSubChildId != -1L)
    {
      View localView1 = localViewHolder.itemView.findViewById(this.mState.mFocusedSubChildId);
  ...
  private void saveFocusInfo()
  {
    ...
    label142:
    for (int i = -1;; i = localViewHolder.getAdapterPosition())
    {
  ...
  public View focusSearch(View paramView, int paramInt)
  {
    ...
    while (isPreferredNextFocus(paramView, localView2, paramInt))
    {
      return localView2;
      label287:
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      continue;
      this.mScrollPointerId = paramMotionEvent.getPointerId(j);
      int i8 = (int)(0.5F + paramMotionEvent.getX(j));
      this.mLastTouchX = i8;
      this.mInitialTouchX = i8;
      int i9 = (int)(0.5F + paramMotionEvent.getY(j));
      this.mLastTouchY = i9;
  ...
  public static abstract class LayoutManager
  {
    ...
    void setMeasuredDimensionFromChildren(int paramInt1, int paramInt2)
    {
      ...
      for (int i1 = 0; i1 < i; i1++)
      {
        ...
        ((RecyclerView.LayoutParams)localView.getLayoutParams());
    ...
    RecyclerView.ViewHolder getScrapViewForPosition(int paramInt1, int paramInt2, boolean paramBoolean)
    {
      ...
      for (int j = 0;; j++)
      {
        if (j < i)
        {
          ...
          if ((localViewHolder1.wasReturnedFromScrap()) || (localViewHolder1.getLayoutPosition() != paramInt1) || (localViewHolder1.isInvalid()) || ((!RecyclerView.this.mState.mInPreLayout) && (localViewHolder1.isRemoved()))) {
            continue;
          }
...
/* Location:              C:\Users\Lab\Desktop\testak-testiput-button-dex2jar.jar!\android\support\v7\widget\RecyclerView.class
