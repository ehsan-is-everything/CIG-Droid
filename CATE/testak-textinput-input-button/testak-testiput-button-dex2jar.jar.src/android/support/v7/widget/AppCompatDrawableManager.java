...
public final class AppCompatDrawableManager
{
  ...
  private ColorStateList createButtonColorStateList(@NonNull Context paramContext, @ColorInt int paramInt, @Nullable ColorStateList paramColorStateList)
  {
    ...
    if (paramColorStateList == null)
    {
      ...
      m = paramInt;
      arrayOfInt1[k] = ColorUtils.compositeColors(i, m);
      n = k + 1;
      arrayOfInt[n] = ThemeUtils.FOCUSED_STATE_SET;
      if (paramColorStateList != null) {
        break label181;
      }
      i1 = paramInt;
      arrayOfInt1[n] = ColorUtils.compositeColors(i, i1);
      i2 = n + 1;
      arrayOfInt[i2] = ThemeUtils.EMPTY_STATE_SET;
      if (paramColorStateList != null) {
        break label196;
      }
    }
    for (;;)
    {
      ...
      j = paramColorStateList.getColorForState(arrayOfInt[0], 0);
      break;
      label166:
      m = paramColorStateList.getColorForState(arrayOfInt[k], 0);
      break label66;
      label181:
      i1 = paramColorStateList.getColorForState(arrayOfInt[n], 0);
      break label99;
      label196:
      paramInt = paramColorStateList.getColorForState(arrayOfInt[i2], 0);
    }
  }
  ...
  ColorStateList getTintList(@NonNull Context paramContext, @DrawableRes int paramInt, @Nullable ColorStateList paramColorStateList)
  {
    ...
    if (paramColorStateList == null)
    {
      ...
      localColorStateList = getTintListFromCache(paramContext, paramInt);
      label20:
      if (localColorStateList == null)
      {
    ...
    for (;;)
    {
      if ((i != 0) && (localColorStateList != null)) {
      ...
      if (paramInt == R.drawable.abc_switch_track_mtrl_alpha) {
        ...
        localColorStateList = createDefaultButtonColorStateList(paramContext, paramColorStateList);
      } else if (paramInt == R.drawable.abc_btn_borderless_material) {
        localColorStateList = createBorderlessButtonColorStateList(paramContext, paramColorStateList);
      } else if (paramInt == R.drawable.abc_btn_colored_material) {
        localColorStateList = createColoredButtonColorStateList(paramContext, paramColorStateList);
...
/* Location:              C:\Users\Lab\Desktop\testak-testiput-button-dex2jar.jar!\android\support\v7\widget\AppCompatDrawableManager.class
