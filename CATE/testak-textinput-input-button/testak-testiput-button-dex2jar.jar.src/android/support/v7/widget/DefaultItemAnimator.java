  ...
  extends SimpleItemAnimator
{
  ...
  void animateChangeImpl(final ChangeInfo paramChangeInfo)
  {
    ...
    for (final View localView2 = localViewHolder2.itemView;; localView2 = null)
    {
      if (localView1 != null)
      {
        ...
        localViewPropertyAnimatorCompat2.alpha(0.0F).setListener(new VpaListenerAdapter()
        {
          public void onAnimationEnd(View paramAnonymousView)
          {
      ...
      if (localView2 != null)
      {
        ...
        localViewPropertyAnimatorCompat1.translationX(0.0F).translationY(0.0F).setDuration(getChangeDuration()).alpha(1.0F).setListener(new VpaListenerAdapter()
        {
          public void onAnimationEnd(View paramAnonymousView)
          {
  ...
  void animateMoveImpl(final RecyclerView.ViewHolder paramViewHolder, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    localViewPropertyAnimatorCompat.setDuration(getMoveDuration()).setListener(new VpaListenerAdapter()
    {
      public void onAnimationCancel(View paramAnonymousView)
      {
        if (i != 0) {
...
/* Location:              C:\Users\Lab\Desktop\testak-testiput-button-dex2jar.jar!\android\support\v7\widget\DefaultItemAnimator.class
