...
/*    */   
/* 24 */   AppOpsManager() { throw new RuntimeException("Stub!"); }
/* 25 */   public static String permissionToOp(String permission) { throw new RuntimeException("Stub!"); }
/* 26 */   public void startWatchingMode(String op, String packageName, OnOpChangedListener callback) { throw new RuntimeException("Stub!"); }
/* 27 */   public void stopWatchingMode(OnOpChangedListener callback) { throw new RuntimeException("Stub!"); }
/* 28 */   public int checkOp(String op, int uid, String packageName) { throw new RuntimeException("Stub!"); }
/* 29 */   public int checkOpNoThrow(String op, int uid, String packageName) { throw new RuntimeException("Stub!"); }
/* 30 */   public int noteOp(String op, int uid, String packageName) { throw new RuntimeException("Stub!"); }
/* 31 */   public int noteOpNoThrow(String op, int uid, String packageName) { throw new RuntimeException("Stub!"); }
/* 32 */   public int noteProxyOp(String op, String proxiedPackageName) { throw new RuntimeException("Stub!"); }
/* 33 */   public int noteProxyOpNoThrow(String op, String proxiedPackageName) { throw new RuntimeException("Stub!"); }
/* 34 */   public int startOp(String op, int uid, String packageName) { throw new RuntimeException("Stub!"); }
/* 35 */   public int startOpNoThrow(String op, int uid, String packageName) { throw new RuntimeException("Stub!"); }
/* 36 */   public void finishOp(String op, int uid, String packageName) { throw new RuntimeException("Stub!"); }
/* 37 */   public void checkPackage(int uid, String packageName) { throw new RuntimeException("Stub!"); }
/*    */   
...
/* Location:              C:\Users\Lab\Desktop\android-jar\android-26.jar!\android\app\AppOpsManager.class
