...
/* 21 */     UNKNOWN;
/*    */     private ScriptUsage() {} }
/* 23 */   UScript() { throw new RuntimeException("Stub!"); }
/* 24 */   public static final int[] getCode(java.util.Locale locale) { throw new RuntimeException("Stub!"); }
/* 25 */   public static final int[] getCode(ULocale locale) { throw new RuntimeException("Stub!"); }
/* 26 */   public static final int[] getCode(String nameOrAbbrOrLocale) { throw new RuntimeException("Stub!"); }
/* 27 */   public static final int getCodeFromName(String nameOrAbbr) { throw new RuntimeException("Stub!"); }
/* 28 */   public static final int getScript(int codepoint) { throw new RuntimeException("Stub!"); }
/* 29 */   public static final boolean hasScript(int c, int sc) { throw new RuntimeException("Stub!"); }
/* 30 */   public static final int getScriptExtensions(int c, BitSet set) { throw new RuntimeException("Stub!"); }
/* 31 */   public static final String getName(int scriptCode) { throw new RuntimeException("Stub!"); }
/* 32 */   public static final String getShortName(int scriptCode) { throw new RuntimeException("Stub!"); }
/* 33 */   public static final String getSampleString(int script) { throw new RuntimeException("Stub!"); }
/* 34 */   public static final ScriptUsage getUsage(int script) { throw new RuntimeException("Stub!"); }
/* 35 */   public static final boolean isRightToLeft(int script) { throw new RuntimeException("Stub!"); }
/* 36 */   public static final boolean breaksBetweenLetters(int script) { throw new RuntimeException("Stub!"); }
/* 37 */   public static final boolean isCased(int script) { throw new RuntimeException("Stub!"); }
/*    */   
...
/* Location:              C:\Users\Lab\Desktop\android-jar\android-26.jar!\android\icu\lang\UScript.class
