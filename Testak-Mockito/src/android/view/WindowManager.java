...
/*     */   {
/*  24 */     public BadTokenException() { throw new RuntimeException("Stub!"); }
/*  25 */     public BadTokenException(String name) { throw new RuntimeException("Stub!"); }
/*     */   }
/*     */   
/*     */   public static class InvalidDisplayException
/*     */     extends RuntimeException {
/*  30 */     public InvalidDisplayException() { throw new RuntimeException("Stub!"); }
/*  31 */     public InvalidDisplayException(String name) { throw new RuntimeException("Stub!"); }
/*     */   }
/*     */   
/*     */   public static class LayoutParams extends ViewGroup.LayoutParams implements Parcelable { public static final int ALPHA_CHANGED = 128;
/*     */     public static final int ANIMATION_CHANGED = 16;
/*     */     
/*  37 */     public LayoutParams() { super();throw new RuntimeException("Stub!"); }
/*  38 */     public LayoutParams(int _type) { super();throw new RuntimeException("Stub!"); }
/*  39 */     public LayoutParams(int _type, int _flags) { super();throw new RuntimeException("Stub!"); }
/*  40 */     public LayoutParams(int _type, int _flags, int _format) { super();throw new RuntimeException("Stub!"); }
/*  41 */     public LayoutParams(int w, int h, int _type, int _flags, int _format) { super();throw new RuntimeException("Stub!"); }
/*  42 */     public LayoutParams(int w, int h, int xpos, int ypos, int _type, int _flags, int _format) { super();throw new RuntimeException("Stub!"); }
/*  43 */     public LayoutParams(Parcel in) { super();throw new RuntimeException("Stub!"); }
/*  44 */     public static boolean mayUseInputMethod(int flags) { throw new RuntimeException("Stub!"); }
/*  45 */     public final void setTitle(CharSequence title) { throw new RuntimeException("Stub!"); }
/*  46 */     public final CharSequence getTitle() { throw new RuntimeException("Stub!"); }
/*  47 */     public void setColorMode(int colorMode) { throw new RuntimeException("Stub!"); }
/*  48 */     public int getColorMode() { throw new RuntimeException("Stub!"); }
/*  49 */     public int describeContents() { throw new RuntimeException("Stub!"); }
/*  50 */     public void writeToParcel(Parcel out, int parcelableFlags) { throw new RuntimeException("Stub!"); }
/*  51 */     public final int copyFrom(LayoutParams o) { throw new RuntimeException("Stub!"); }
/*  52 */     public String debug(String output) { throw new RuntimeException("Stub!"); }
...
/*     */ 
/*     */ 
/* 201 */     public static final Parcelable.Creator<LayoutParams> CREATOR = null;
...
/* Location:              C:\Users\Lab\Desktop\android-jar\android-26.jar!\android\view\WindowManager.class
