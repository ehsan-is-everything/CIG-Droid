...
/*  23 */     public final boolean isFeatureSupported(String name) { throw new RuntimeException("Stub!"); }
/*  24 */     public final boolean isFeatureRequired(String name) { throw new RuntimeException("Stub!"); }
/*  25 */     public final boolean isFormatSupported(MediaFormat format) { throw new RuntimeException("Stub!"); }
/*  26 */     public MediaFormat getDefaultFormat() { throw new RuntimeException("Stub!"); }
/*  27 */     public String getMimeType() { throw new RuntimeException("Stub!"); }
/*  28 */     public int getMaxSupportedInstances() { throw new RuntimeException("Stub!"); }
/*  29 */     public MediaCodecInfo.AudioCapabilities getAudioCapabilities() { throw new RuntimeException("Stub!"); }
/*  30 */     public MediaCodecInfo.EncoderCapabilities getEncoderCapabilities() { throw new RuntimeException("Stub!"); }
/*  31 */     public MediaCodecInfo.VideoCapabilities getVideoCapabilities() { throw new RuntimeException("Stub!"); }
/*  32 */     public static CodecCapabilities createFromProfileLevel(String mime, int profile, int level) { throw new RuntimeException("Stub!"); }
/*     */     
/*     */ 
/*     */     @Deprecated
...
/* 128 */     public int[] colorFormats = null;
/* 129 */     public MediaCodecInfo.CodecProfileLevel[] profileLevels = null;
/*     */   }
/*     */   
/*     */   public static final class AudioCapabilities {
/* 133 */     AudioCapabilities() { throw new RuntimeException("Stub!"); }
/* 134 */     public Range<Integer> getBitrateRange() { throw new RuntimeException("Stub!"); }
/* 135 */     public int[] getSupportedSampleRates() { throw new RuntimeException("Stub!"); }
/* 136 */     public Range<Integer>[] getSupportedSampleRateRanges() { throw new RuntimeException("Stub!"); }
/* 137 */     public int getMaxInputChannelCount() { throw new RuntimeException("Stub!"); }
/* 138 */     public boolean isSampleRateSupported(int sampleRate) { throw new RuntimeException("Stub!"); }
/*     */   }
/*     */   
/*     */   public static final class VideoCapabilities {
/* 142 */     VideoCapabilities() { throw new RuntimeException("Stub!"); }
/* 143 */     public Range<Integer> getBitrateRange() { throw new RuntimeException("Stub!"); }
/* 144 */     public Range<Integer> getSupportedWidths() { throw new RuntimeException("Stub!"); }
/* 145 */     public Range<Integer> getSupportedHeights() { throw new RuntimeException("Stub!"); }
/* 146 */     public int getWidthAlignment() { throw new RuntimeException("Stub!"); }
/* 147 */     public int getHeightAlignment() { throw new RuntimeException("Stub!"); }
/* 148 */     public Range<Integer> getSupportedFrameRates() { throw new RuntimeException("Stub!"); }
/* 149 */     public Range<Integer> getSupportedWidthsFor(int height) { throw new RuntimeException("Stub!"); }
/* 150 */     public Range<Integer> getSupportedHeightsFor(int width) { throw new RuntimeException("Stub!"); }
/* 151 */     public Range<Double> getSupportedFrameRatesFor(int width, int height) { throw new RuntimeException("Stub!"); }
/* 152 */     public Range<Double> getAchievableFrameRatesFor(int width, int height) { throw new RuntimeException("Stub!"); }
/* 153 */     public boolean areSizeAndRateSupported(int width, int height, double frameRate) { throw new RuntimeException("Stub!"); }
/* 154 */     public boolean isSizeSupported(int width, int height) { throw new RuntimeException("Stub!"); } }
/*     */   
/*     */   public static final class EncoderCapabilities { public static final int BITRATE_MODE_CBR = 2;
/*     */     
/* 158 */     EncoderCapabilities() { throw new RuntimeException("Stub!"); }
/* 159 */     public Range<Integer> getComplexityRange() { throw new RuntimeException("Stub!"); }
/* 160 */     public boolean isBitrateModeSupported(int mode) { throw new RuntimeException("Stub!"); }
/*     */     
/*     */     public static final int BITRATE_MODE_CQ = 0;
/*     */     public static final int BITRATE_MODE_VBR = 1; }
/*     */   
/*     */   public static final class CodecProfileLevel { public static final int AACObjectELD = 39;
/*     */     
/* 167 */     public CodecProfileLevel() { throw new RuntimeException("Stub!"); }
/*     */     
...
/*     */     public int profile; }
/*     */   
/* 331 */   MediaCodecInfo() { throw new RuntimeException("Stub!"); }
/* 332 */   public final String getName() { throw new RuntimeException("Stub!"); }
/* 333 */   public final boolean isEncoder() { throw new RuntimeException("Stub!"); }
/* 334 */   public final String[] getSupportedTypes() { throw new RuntimeException("Stub!"); }
/* 335 */   public final CodecCapabilities getCapabilitiesForType(String type) { throw new RuntimeException("Stub!"); }
/*     */ }


/* Location:              C:\Users\Lab\Desktop\android-jar\android-26.jar!\android\media\MediaCodecInfo.class
