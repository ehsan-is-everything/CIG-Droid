...
/*    */   
/* 20 */   public MediaFormat() { throw new RuntimeException("Stub!"); }
/* 21 */   public final boolean containsKey(String name) { throw new RuntimeException("Stub!"); }
/* 22 */   public final int getInteger(String name) { throw new RuntimeException("Stub!"); }
/* 23 */   public final long getLong(String name) { throw new RuntimeException("Stub!"); }
/* 24 */   public final float getFloat(String name) { throw new RuntimeException("Stub!"); }
/* 25 */   public final String getString(String name) { throw new RuntimeException("Stub!"); }
/* 26 */   public final ByteBuffer getByteBuffer(String name) { throw new RuntimeException("Stub!"); }
/* 27 */   public boolean getFeatureEnabled(String feature) { throw new RuntimeException("Stub!"); }
/* 28 */   public final void setInteger(String name, int value) { throw new RuntimeException("Stub!"); }
/* 29 */   public final void setLong(String name, long value) { throw new RuntimeException("Stub!"); }
/* 30 */   public final void setFloat(String name, float value) { throw new RuntimeException("Stub!"); }
/* 31 */   public final void setString(String name, String value) { throw new RuntimeException("Stub!"); }
/* 32 */   public final void setByteBuffer(String name, ByteBuffer bytes) { throw new RuntimeException("Stub!"); }
/* 33 */   public void setFeatureEnabled(String feature, boolean enabled) { throw new RuntimeException("Stub!"); }
/* 34 */   public static final MediaFormat createAudioFormat(String mime, int sampleRate, int channelCount) { throw new RuntimeException("Stub!"); }
/* 35 */   public static final MediaFormat createSubtitleFormat(String mime, String language) { throw new RuntimeException("Stub!"); }
/* 36 */   public static final MediaFormat createVideoFormat(String mime, int width, int height) { throw new RuntimeException("Stub!"); }
...
/* Location:              C:\Users\Lab\Desktop\android-jar\android-26.jar!\android\media\MediaFormat.class
