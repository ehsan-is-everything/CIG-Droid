...
/*    */   extends Exception
/*    */ {
/* 30 */   public URISyntaxException(String input, String reason, int index) { throw new RuntimeException("Stub!"); }
/* 31 */   public URISyntaxException(String input, String reason) { throw new RuntimeException("Stub!"); }
