...
/*    */   
/* 56 */   protected AbstractQueuedLongSynchronizer() { throw new RuntimeException("Stub!"); }
/* 57 */   protected final long getState() { throw new RuntimeException("Stub!"); }
/* 58 */   protected final void setState(long newState) { throw new RuntimeException("Stub!"); }
/* 59 */   protected final boolean compareAndSetState(long expect, long update) { throw new RuntimeException("Stub!"); }
/* 60 */   protected boolean tryAcquire(long arg) { throw new RuntimeException("Stub!"); }
/* 61 */   protected boolean tryRelease(long arg) { throw new RuntimeException("Stub!"); }
/* 62 */   protected long tryAcquireShared(long arg) { throw new RuntimeException("Stub!"); }
/* 63 */   protected boolean tryReleaseShared(long arg) { throw new RuntimeException("Stub!"); }
/* 64 */   protected boolean isHeldExclusively() { throw new RuntimeException("Stub!"); }
/* 65 */   public final void acquire(long arg) { throw new RuntimeException("Stub!"); }
/* 66 */   public final void acquireInterruptibly(long arg) throws InterruptedException { throw new RuntimeException("Stub!"); }
/* 67 */   public final boolean tryAcquireNanos(long arg, long nanosTimeout) throws InterruptedException { throw new RuntimeException("Stub!"); }
/* 68 */   public final boolean release(long arg) { throw new RuntimeException("Stub!"); }
/* 69 */   public final void acquireShared(long arg) { throw new RuntimeException("Stub!"); }
/* 70 */   public final void acquireSharedInterruptibly(long arg) throws InterruptedException { throw new RuntimeException("Stub!"); }
/* 71 */   public final boolean tryAcquireSharedNanos(long arg, long nanosTimeout) throws InterruptedException { throw new RuntimeException("Stub!"); }
/* 72 */   public final boolean releaseShared(long arg) { throw new RuntimeException("Stub!"); }
...
/* Location:              C:\Users\Lab\Desktop\android-jar\android-26.jar!\java\util\concurrent\locks\AbstractQueuedLongSynchronizer.class
