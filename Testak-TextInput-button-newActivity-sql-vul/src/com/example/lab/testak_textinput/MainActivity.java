...
public class MainActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final EditText et = (EditText) Debug.makeSymbolicRef("editText", new EditText());// (EditText)
																							// findViewById(R.id.editText);

		final EditText et_del = (EditText) Debug.makeSymbolicRef("editText_del", new EditText());// (EditText)
																									// findViewById(R.id.editText_del);
		...
		fab.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				Snackbar.make(view, "your record with name=" + et_del.getText().toString() + " deleted!!",
						Snackbar.LENGTH_LONG).setAction("Action", null).show();
				int a = db.delete("student", "name=?", new String[] { et_del.getText().toString() });
				if (a == 0)
					Snackbar.make(view, "your record with name=" + et_del.getText().toString() + "cant be deleted!!",
							Snackbar.LENGTH_LONG).setAction("Action", null).show();
				else
					Snackbar.make(view, "your record with name=" + et_del.getText().toString() + " deleted!!",
							Snackbar.LENGTH_LONG).setAction("Action", null).show();
		...
		/*Button*/View b = /*(Button)*/ findViewById(R.id.button);
		b.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Cursor c = db.query(false, "student", null, "stdno='" + et.getText().toString() + "'", null, null, null,
						null, null);
