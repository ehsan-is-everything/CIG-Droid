...
public class MunchLifeActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Button up_button = new Button();// (Button)findViewById(R.id.up_button);
		up_button.setOnClickListener(levelUpClickListener);

		Button down_button = new Button();// (Button)findViewById(R.id.down_button);
		down_button.setOnClickListener(levelDownClickListener);

		Button up_gear_button = new Button();// (Button)findViewById(R.id.up_gear_button);
		up_gear_button.setOnClickListener(gearUpClickListener);

		Button down_gear_button = new Button();// (Button)findViewById(R.id.down_gear_button);
		down_gear_button.setOnClickListener(gearDownClickListener);

		current_level = new TextView();// (TextView)findViewById(R.id.current_level);
		current_gear_level = new TextView();// (TextView)findViewById(R.id.current_gear_level);
		total_level = new TextView();// (TextView)findViewById(R.id.total_level);
