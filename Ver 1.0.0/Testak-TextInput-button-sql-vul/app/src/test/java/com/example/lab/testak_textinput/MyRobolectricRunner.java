...
/**
 * Created by ehsan on 10/6/17.
 */

public class MyRobolectricRunner extends RobolectricTestRunner {
     ...
     */
    public MyRobolectricRunner(Class<?> testClass) throws InitializationError {
        super(testClass);
    }
