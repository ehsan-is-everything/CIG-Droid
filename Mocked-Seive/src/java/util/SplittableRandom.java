...
/*    */ {
/* 29 */   public SplittableRandom(long seed) { throw new RuntimeException("Stub!"); }
/* 30 */   public SplittableRandom() { throw new RuntimeException("Stub!"); }
/* 31 */   public SplittableRandom split() { throw new RuntimeException("Stub!"); }
/* 32 */   public int nextInt() { throw new RuntimeException("Stub!"); }
/* 33 */   public int nextInt(int bound) { throw new RuntimeException("Stub!"); }
/* 34 */   public int nextInt(int origin, int bound) { throw new RuntimeException("Stub!"); }
/* 35 */   public long nextLong() { throw new RuntimeException("Stub!"); }
/* 36 */   public long nextLong(long bound) { throw new RuntimeException("Stub!"); }
/* 37 */   public long nextLong(long origin, long bound) { throw new RuntimeException("Stub!"); }
/* 38 */   public double nextDouble() { throw new RuntimeException("Stub!"); }
/* 39 */   public double nextDouble(double bound) { throw new RuntimeException("Stub!"); }
/* 40 */   public double nextDouble(double origin, double bound) { throw new RuntimeException("Stub!"); }
/* 41 */   public boolean nextBoolean() { throw new RuntimeException("Stub!"); }
...
/* Location:              C:\Users\Mahmoud\Desktop\android.jar!\java\util\SplittableRandom.class
