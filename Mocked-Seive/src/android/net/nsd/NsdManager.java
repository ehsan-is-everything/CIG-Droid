...
/*    */ 
/*    */ 
/* 41 */   NsdManager() { throw new RuntimeException("Stub!"); }
/* 42 */   public void registerService(NsdServiceInfo serviceInfo, int protocolType, RegistrationListener listener) { throw new RuntimeException("Stub!"); }
/* 43 */   public void unregisterService(RegistrationListener listener) { throw new RuntimeException("Stub!"); }
/* 44 */   public void discoverServices(String serviceType, int protocolType, DiscoveryListener listener) { throw new RuntimeException("Stub!"); }
/* 45 */   public void stopServiceDiscovery(DiscoveryListener listener) { throw new RuntimeException("Stub!"); }
/* 46 */   public void resolveService(NsdServiceInfo serviceInfo, ResolveListener listener) { throw new RuntimeException("Stub!"); }
/*    */   
